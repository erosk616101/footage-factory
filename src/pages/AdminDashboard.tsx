...
import { CheckCircle, Download, Edit, Eye, Search, Trash2, User, Users, XCircle } from 'lucide-react';
...
const AdminDashboard = () => {
  ...
  // Mock data
  const users = [
    { id: '1', name: 'John Doe', email: 'john@example.com', role: 'user', status: 'active', uploads: 12, joined: '2023-03-15' },
    { id: '2', name: 'Jane Smith', email: 'jane@example.com', role: 'user', status: 'active', uploads: 8, joined: '2023-04-22' },
    { id: '3', name: 'Mike Johnson', email: 'mike@example.com', role: 'user', status: 'suspended', uploads: 5, joined: '2023-05-10' },
